...
from rst_courses_converter import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('RST Courses Converter')
...
def main(args=None):
    """
    Called with ``python -m rst_courses_converter.tests``: run main test suite.
    """
    ...
    import rst_courses_converter.tests as test_module
